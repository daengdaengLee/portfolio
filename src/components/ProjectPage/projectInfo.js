const projectInfo = [
  {
    ...
    desc: 'Vue.js 를 이용해 만든 웹 계산기입니다. Vuex 를 이용하여 상태를 관리하고 있습니다.',
    pageLink: 'https://daengdaenglee.github.io/calculator_with_vuejs/',
    repoLink: 'https://github.com/daengdaengLee/calculator_with_vuejs',
  },
  {
    id: 2,
    ...
    desc: 'Vue.js 를 이용해 만든 웹 토마토 시계입니다. Vuex 를 이용하여 상태를 관리합니다. JavaScript 의 setInterval 메소드와 clearInterval 메소드를 이용해 타이머 기능을 구현했습니다.',
    pageLink: 'https://daengdaenglee.github.io/pomodoro_clock_vuejs/',
    repoLink: 'https://github.com/daengdaengLee/pomodoro_clock_vuejs',
  },
  {
    id: 3,
    ...
    desc: 'React 를 이용해 화면을 구성했습니다. YTS torrents 에서 제공하는 Web API 를 통해 영화 차트 정보를 가져옵니다.',
