const projectInfo = [
  ...
  },
  {
    ...
    desc: 'React.js를 이용해 만든 영화 차트 사이트입니다. 영화 정보는 yts.am의 API를 통해 가져옵니다. 다운로드 횟수를 기준으로 상위 20편의 영화 정보를 가져옵니다. 가져온 정보를 바탕으로 포스터, 제목, 장르, 시놉시스를 보여줍니다. 반응형으로 화면을 구성하여 모바일과 데스크탑 환경 모두에서 화면을 읽기 쉽습니다.',
  },
];
